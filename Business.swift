...
class Business: NSObject {
   ...
   class func searchWithTerm(term: String, offset: Int, category: [String]?, completion: @escaping ([Business]?, Error?) -> Void) {
        _ = YelpClient.sharedInstance.searchWithTerm(term, completion: completion)
    }

    class func searchWithTerm(term: String, offset: Int, category: [String]?, sort: YelpSortMode?, categories: [String]?, completion: @escaping ([Business]?, Error?) -> Void) -> Void {
